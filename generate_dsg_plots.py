...
if __name__ == "__main__":
    ...
    if not generate_two:
        ...
        plot_gt_inferred_wrt_human, plot_gt_robot_wrt_initial, plot_gt_human_wrt_initial = generate_dsg_smcc_plot(ax, episode_dir=f"episodes/episode_{episode_number}", description="Parents are Out GT Robot GT Human", ablation_annotation="", show_y_label=False, gt_colors=True)
