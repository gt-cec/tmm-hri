...
for frame in "${existing_frames[@]}"; do
    ...
    next_frame="Action_${next_frame_number}_0_normal.png"
...
ffmpeg -framerate 10 -i episodes/episode/frame_%d.png -c:v libx264 -r 30 -pix_fmt yuv420p output.mp4 -y
