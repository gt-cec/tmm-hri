...
FRAMES_DIR="visualization_perception"
...
ffmpeg -framerate 10 -i visualization_perception/frame_%d.png -c:v libx264 -r 30 -pix_fmt yuv420p visualization_perception.mp4 -y
